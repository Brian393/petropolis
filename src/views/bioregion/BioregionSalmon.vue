...
<template>
  <div class="aside-content">
    ...
    <p>The data prepared by the National Oceanic and Atmospheric Administration are far more complex than any graphic technique could reveal. They divide the four endangered species not only into distinct seasonal runs (spring, summer or fall) but also into distinct gene pools, associated with the real pools and gravel beds that call the fish back to spawn. Any stream reach can be home to multiple stocks of fish, or "evolutionarily significant units" (ESUs), which is the term used under the Endangered Species Act. Further documents locate the areas where populations have gone extinct, or where stream reaches have been entirely blocked by dams. More speculative studies try to assess the geographical range in which the fish could potentially flourish. This kind of science is beautiful, because it opens windows onto non-human worlds.</p>
