<template>
  <div class="aside-content">
    <div style="text-align: center;">
      <h1 style="color:#E00607; font-size:170%">before it's too late</h1>
    </div>
    <img src="images/OilHead.jpg" class="fullwidth"><div class="caption"></div>

    <p><strong></strong></p>

    <p style="font-size:120%;"><strong><em>From the Tars Sands to the Gulf of Mexico, the North American pipeline network pumps a future of melting icecaps, sea-level rise, drought and forest fires. Every refinery is a "bomb train" for the world.</em></strong></p>
