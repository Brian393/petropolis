<template>
  <div class="aside-content">
    <div>
    <p><img id="sidepanel-image" src="images/OilHead.jpg" class="fullwidth"></p></div>
...
<Accordion :open="false">
  ...
  <div class="flex">
    ...
    <p>* These appear when you zoom in.<br><br>Click any element to find out more.<br><br>spotlight appears at full zoom.<br>Press "shift" + &#8593; to enlarge it.<br>Press "shift" + &#8595; to shrink it.</p>
  </div>
</Accordion>
