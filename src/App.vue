<template>
  <div id="app">
    <main>
      <nav>
        <span>&nbsp;</span>
        <router-link to="/walkaboutit/2020" v-bind:class="{active: $route.name && $route.name.match('watershed')}" @click.native="routeClick('/walkaboutit/2020')">Walk About It</router-link>
        <span>&nbsp;</span>
