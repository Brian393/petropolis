  ...
  computed: {
    ...
    petropolisOilLayers: function() {
      return [
        ...
        this.makeGeoJSONLineVectorLayerWithStyle1(
          'geojson/CancelledOilLines.geojson',
          0,
          1,
          32000,
          3
        ...
        this.makeGeoJSONLineVectorLayer(
          'geojson/ContestedOilLines.geojson',
          10,
          1,
          16000,
    ...
    petropolisOilPipelineLayers: function() {
      return [
        ...
        ...this.baseLayers,
        this.makeGeoJSONPointVectorLayerWithCircleStyle(
          'geojson/Spills_20yrs.geojson',
          0,
          null,
          4,
          2000,
        ...
        this.makeGeoJSONLineVectorLayer(
          'geojson/GlobalPipelines.geojson',
          0,
          20,
          64000,
          '#000000',
        ...
        this.makeGeoJSONPointVectorLayer(
          'geojson/GlobalRefineries.geojson',
          0,
          'icons/Refinery3.png',
          null,
          1,
        ...
        this.makeGeoJSONPointVectorLayer(
          'geojson/CrudeDerailments.geojson',
          0,
        ...
        this.makeGeoJSONPointVectorLayer(
          'geojson/VideoOilIndustry.geojson',
          0,
          'icons/Warning.png',
          null,
          1,
    ...
    petropolisOilWorldLayers: function() {
      return [
        ...
        new Tile({
          source: new XYZ({
            url:
              'https://stamen-tiles-{a-d}.a.ssl.fastly.net/toner-lite/{z}/{x}/{y}.png'
          }),
          opacity: 1,
          minResolution: 0.25,
          maxResolution: 200
        ...
        this.makeGeoJSONPointVectorLayerWithCircleStyle2(
          'geojson/GiantOilFields.geojson',
          0,
          null,
          4,
          4000,
    ...
    petropolisGasLayers: function() {
      return [
        ...
        this.makeGeoJSONLineVectorLayer(
          'geojson/ContestedGasLines.geojson',
          0.5,
          16000,
          'black',
          6.5
        ...
        this.makeGeoJSONPointVectorLayer(
          ...
          0,
          'icons/LNGterminal.png',
          null,
          1,
          16000
        ),
        this.makeGeoJSONPointVectorLayer(
          'geojson/Gasland.geojson',
          0,
          'icons/PetropolisGasland2.gif',
          null,
          4,
          8000
        )
    ...
    petropolisCoalLayers: function() {
      return [
        new Tile({
          source: new XYZ({
            url:
              'https://{a-d}.basemaps.cartocdn.com/dark_nolabels/{z}/{x}/{y}{r}.png'
          }),
          opacity: 1,
          minResolution: 0.5
        }),
        ...
        this.makeGeoJSONPointVectorLayer(
          ...
          0,
          'icons/Smokestack6.png',
          null,
          1,
          64000
        ),
        this.makeGeoJSONPointVectorLayerWithCircleStyle1(
          'geojson/Coal_Mines.geojson',
          0,
          null,
          4,
          64000,
    ...
    petropolisCoalIndustryLayers: function() {
      return [
        ...
        this.makeGeoJSONPointVectorLayer(
          'geojson/UndergroundCoal.geojson',
          0,
          'icons/CoalWagon.png',
          null,
          1,
    ...
    petropolisCoalWorldLayers: function() {
      return [
        ...
        new Tile({
          source: new XYZ({
            url:
              'https://cartocdn_{a-d}.global.ssl.fastly.net/base-midnight/{z}/{x}/{y}.png'
          }),
          opacity: 0.8,
          minResolution: 0.25,
          maxResolution: 800,
        ...
        new Tile({
          ...
          source: new XYZ({
            url:
              'https://{a-c}.tiles.openrailwaymap.org/signals/{z}/{x}/{y}.png',
